...
case $cmd in
  1) curl -s http://ip-api.com/$IP_USER ; sleep 5 ; main_menu ;;
...
function admin_panel() {
     ...
     case $adm in
       [Aa]) echo "Starting Social Hack..." ; sleep 3 ; admin_panel ;;
       [Bb]) echo "Configuring Bot..." ; sleep 3 ; admin_panel ;;
       [Cc]) echo "Accessing Database..." ; sleep 3 ; admin_panel ;;
       [Ss]|"s"|"S") main_menu ;;
